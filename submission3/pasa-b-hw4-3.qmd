...
def covariate_balance(df, cutoff, bandwidth=0.125):
    ...
    balance['Cutoff'] = cutoff
    return balance.reset_index().rename(columns={'index': 'Characteristic'})

# Step 3: Combine balance tables
balance_all = pd.concat([
    covariate_balance(df_2010, 3.0),
    covariate_balance(df_2010, 3.5)
])

# Step 4: Create pivot table
pivot_table = balance_all.pivot(index='Characteristic', columns='Cutoff')

# Optional: Clean up multi-index column names
