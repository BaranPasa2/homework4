...
plt.show()
```
These two histograms show the **distribution of raw star ratings** around the **3.0** and **3.5** cutoff points, which are used as the running variables in your regression discontinuity (RD) analysis.
